        ...
        setPlans([
          {
            ...
            name: "Básico",
            description:
              "Perfecto para comenzar con la gestión financiera inteligente",
            price: "3.99",
            frequency: "mensual",
            features: [
              "Entrada de voz",
          ...
          },
          {
            ...
            name: "Premium",
            description:
              "Para usuarios avanzados que quieren insights avanzados y soporte prioritario",
            price: "9.99",
            frequency: "mensual",
            features: [
              "Entrada de voz",
      ...
      <div className="container px-4 md:px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-muted-foreground text-lg max-w-2xl mx-auto">
            Descubre la potencialidad completa de tu gestión financiera con
            nuestros planes personalizados. Comienza gratis por 14 días, sin
            tarjeta de crédito.
          </p>
        </div>
              ...
              <CardContent className="space-y-6">
                <div className="mb-8">
                  ...
                  <p className="text-sm text-muted-foreground mt-2">
                    14-día de prueba gratuita incluida
                  </p>
                </div>
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p className="max-w-xs">
                          Aprende más sobre {feature.name}
                        </p>
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
